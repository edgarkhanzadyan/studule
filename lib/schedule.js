      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', { style: style.timeInput, placeholder: 'time of that class(from)*', onChange: this.onTimeChangeFrom, value: this.state.bufTimeFrom }),
            React.createElement('input', { style: style.timeInput, placeholder: 'time of that class(to)*', onChange: this.onTimeChangeTo, value: this.state.bufTimeTo }),
