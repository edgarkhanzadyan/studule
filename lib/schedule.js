    ...
    value: function render() {
      ...
      var makeHomework = this.state.hw.map(function (homew, i) {
        return React.createElement(
          'li',
          { key: i, style: style.homeworkItem },
          homew
        );
      });
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', { style: style.timeInput, placeholder: 'Time (from)*', onChange: this.onTimeChangeFrom, value: this.state.bufTimeFrom }),
            React.createElement('input', { style: style.timeInput, placeholder: 'Time (to)*', onChange: this.onTimeChangeTo, value: this.state.bufTimeTo }),
            React.createElement('input', { style: style.dayInput, placeholder: 'Day of the week*', onChange: this.onDayChange, value: this.state.bufDay }),
            React.createElement('input', { style: style.homeworkInput, placeholder: 'Homework (if applicable)', onChange: this.onHomeworkChange, value: this.state.bufHomework })
          ),
          React.createElement(
            'button',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              { style: style.homeworkTab },
              React.createElement(
                'div',
                { style: style.homeworkLogo },
                'homework tab'
              ),
              React.createElement(
                'div',
